...
class UserRoutine():
        ...
        def __init__(self, data: dict):
            self.USER_ROUTINE_ID = data['USER_ROUTINE_ID']
        ...
        def convertToTuple(self, routine):
            data = (
            routine.USER_ROUTINE_ID, routine.USER_ID, routine.SKINTYPE_NAME, routine.ROUTINE_NUMBER, routine.ROUTINE_NAME,
            routine.ROUTINE_PRODUCT,
            routine.ROUTINE_IMAGE, routine.ROUTINE_NOTE,routine.ROUTINE_RATING)
            return data

        def convertToUserRoutine(self, routine,user_id):
            data = (
                '', user_id, routine["SKINTYPE_NAME"], routine["ROUTINE_NUMBER"],
